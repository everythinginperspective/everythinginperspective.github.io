<template>
  <main v-if="mnemonic">
        ...
        <div class="article-tags">
          ...
          <ul>
            <li v-for="tag in mnemonic.tags" :key="tag">
              <a :href="`/mnemonics?tag=${tag}`" class="tag-link">
                #{{ tag }}
              </a>
            </li>
          </ul>
    ...
    <nav class="article-nav">
      <a href="/mnemonics" class="nav-back">
        ← Back to Mnemonics
      </a>
    </nav>
  ...
  <main v-else class="not-found">
    ...
    <a href="/mnemonics" class="nav-back">Back to Mnemonics</a>
  </main>
</template>
...
const { data: mnemonic } = await useAsyncData(`mnemonic-${route.path}`, () =>
  queryCollection('mnemonics').path(route.path).first()
)
